...
const NotificationScreen = () => {
  ...
  return (
    <div className="flex h-screen bg-black justify-center items-center ">
      <div className="h-[844px] w-[390px] bg-gradient-to-br from-purple-500 via-blue-600 to-teal-800 p-4 text-black">
        {/* Status Bar */}
        ...
        <div className="justify-self-center w-40 h-1 bg-black rounded-full absolute inset-x-0 bottom-0 mb-6"></div>
      </div>
    </div>
  );
};
